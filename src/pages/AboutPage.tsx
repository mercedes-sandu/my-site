        ...
        <StyledContainer container spacing={2}>
            <Grid item md={12}>
                ...
                <StyledParagraph variant="body1">
                    ...
                    based games. I love developing games and am currently a gameplay engineer 
                    at <StyledInlineLink href="">Overture Games</StyledInlineLink>, a startup founded 
                    at <StyledInlineLink href="">The Garage</StyledInlineLink> at Northwestern making games to 
                ...
                <StyledParagraph variant="body1">
                    ...
                    game called <StyledInlineLink href="">Intervallic</StyledInlineLink>, which currently 
                    allows players to control an adorable robot-alien-space cat with input from a midi 
                    instrument. By the end of each level, the player will have played through an entire song! 
                    I have been playing piano for over 14 years now, and I can definitely say that working 
                    on this project has helped me practice more!
                </StyledParagraph>
                <StyledParagraph variant="body1">
                ...
                <StyledParagraph variant="body1">
                    ...
                    namely <StyledInlineLink href="">Dr. Shuyi Weng</StyledInlineLink> and <StyledInlineLink href="">Dr. Ian Horswill</StyledInlineLink>, 
                    respectively. My <StyledInlineLink href="">math research</StyledInlineLink> explores the construction of 
                    three-dimensional shapes from two-dimensional polygons, which has been presented in both 
                    oral presentation and paper formats. My <StyledInlineLink href="">computer science research</StyledInlineLink> is 
                    being done in tandem with my Master's degree, and I am currently working on 
                    expanding <StyledInlineLink href="">Imaginarium</StyledInlineLink> and <StyledInlineLink href="">CatSAT</StyledInlineLink>.
                </StyledParagraph>
                <StyledParagraph variant="body1">
                    ...
                    shop, play piano, <StyledInlineLink href="">arrange music</StyledInlineLink>, create art, and read.
                </StyledParagraph>
                <StyledParagraph variant="body1">
                    If you have any questions or comments, feel free to <StyledInlineLink href="">email me</StyledInlineLink> or 
