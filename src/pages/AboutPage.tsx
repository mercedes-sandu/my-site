    ...
    <StyledContainer container sx={{ pt: 8, pl: 20, pr: 20 }}>
      <Grid item md={12}>
        ...
        <StyledParagraph variant="body1">
          ...
          computer science researcher exploring the use of AI in narrative based
          games. I love developing games and am currently a gameplay engineer at{" "}
        ...
        <StyledParagraph variant="body1">
          ...
          creating games and apps for class, and developing games and software
          for Overture. At Overture, I'm working on a game called{" "}
          ...
          with input from a midi instrument. By the end of each level, the
          player will have played through an entire song! I have been playing
          piano for over 14 years now, and I can definitely say that working on
          this project has helped me practice more!
        </StyledParagraph>
        <StyledParagraph variant="body1">
          I love working with Unity and programming in C#, but I also have some
          experience with Python, HTML, CSS, JavaScript/TypeScript, Java, and
          many more. I am also familiar with many languages and programs used
          for math, such as LaTeX, Mathematica, and MatLab.
        </StyledParagraph>
        <StyledParagraph variant="body1">
          ...
          respectively. My{" "}
          <StyledInlineLink href="">math research</StyledInlineLink> explores
          the construction of three-dimensional shapes from two-dimensional
          polygons, which has been presented in both oral presentation and paper
          formats. My{" "}
        ...
        <StyledParagraph variant="body1">
          Now that you've read plenty about the work that I do, I'm sure you'd
          be surprised to find out that I have plenty of free time! In this free
          ...
          <StyledInlineLink href="">arrange music</StyledInlineLink>, create
          art, and read.
        </StyledParagraph>
        <StyledParagraph variant="body1">
